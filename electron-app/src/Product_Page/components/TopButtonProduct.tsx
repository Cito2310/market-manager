...
interface props {
    onSetModalCreateProduct: () => void;
    onSearch: () => void;
    registerReturn: UseFormRegisterReturn<"search">;
}

export const TopButtonProduct = ({ onSetModalCreateProduct, registerReturn, onSearch }: props) => {
    return (
        <div className="
            fixed right-0 top-0
        ...
        ">
            <ButtonSvg className="bg-card_btn text-card_btnText w-8" element="plus" onClick={onSetModalCreateProduct}/>
